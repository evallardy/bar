...
urlpatterns = [
    ...
    path('administrador/dias/', views.AdminWorkdayListView.as_view(), name='admin-workday-list'),
    path('administrador/dias/<int:workday_id>/', views.AdminWorkdayDetailView.as_view(), name='admin-workday-detail'),
    path('administrador/dias/comanda/<int:order_id>/', views.AdminWorkdayOrderDetailView.as_view(), name='admin-workday-order-detail'),
    ...
    path('comandas/borrador/catalogo/', views.DraftOrderCatalogView.as_view(), name='draft-order-catalog'),
    path('comandas/borrador/reservar/', views.DraftOrderReserveView.as_view(), name='draft-order-reserve'),
    path('comandas/borrador/liberar/', views.DraftOrderReleaseView.as_view(), name='draft-order-release'),
    path('comandas/borrador/liberar-todo/', views.DraftOrderReleaseAllView.as_view(), name='draft-order-release-all'),
    ...
    path('caja/item/<int:item_id>/precio/', views.OrderItemPriceUpdateView.as_view(), name='order-item-price-update'),
    path('caja/item/<int:item_id>/precio/historial/', views.OrderItemPriceHistoryView.as_view(), name='order-item-price-history'),
